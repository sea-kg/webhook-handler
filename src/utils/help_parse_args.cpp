...
HelpParseArg::HelpParseArg(const std::string &sName, const std::string &sAlias, const bool &bIsOption, const std::string &sDescription) {
     m_sName = sName;
     m_sAlias = sAlias;
...
HelpParseArgs::HelpParseArgs(int argc, char** argv){
    ...
    addHelp("--help", "-h", false,
        "This help");

    addHelp("--version", "-v", false,
        "Print version");
}
...
void HelpParseArgs::addHelp(const std::string &sName, const std::string &sAlias, bool bIsOption, const std::string &sDescription) {
    m_vHelpArgs.push_back(new HelpParseArg(sName, sAlias, bIsOption, sDescription));
}
...
bool HelpParseArgs::handleDefaultHelps() {
    if (has("--version")) {
